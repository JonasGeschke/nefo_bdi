...
q3_8_1 <- barplot(Q3_8_1_rel,
        ...
        legend.text = TRUE,
        args.legend = list("topright", bty = "n"))
text(x = q3_8_1, y = Q3_8_1_rel, label = paste("n = ", Q3_8_1, " / ", round(Q3_8_1_rel, digits = 0), "%", sep = ""), pos = 3, cex = 0.8, col = "black")
...
q3_8_2 <- barplot(Q3_8_2_rel,
        ...
        legend.text = TRUE,
        args.legend = list("topright", bty = "n"))
text(x = q3_8_2, y = Q3_8_2_rel, label = paste("n = ", Q3_8_2, " / ", round(Q3_8_2_rel, digits = 0), "%", sep = ""), pos = 3, cex = 0.8, col = "black")
...
q3_8_3 <- barplot(Q3_8_3_rel,
        ...
        legend.text = TRUE,
        args.legend = list("topright", bty = "n"))
text(x = q3_8_3, y = Q3_8_3_rel, label = paste("n = ", Q3_8_3, " / ", round(Q3_8_3_rel, digits = 0), "%", sep = ""), pos = 3, cex = 0.8, col = "black")

Q4_1_sum <- as.numeric(table(Q4_1))
names(Q3_7_sum) <- c("4_1_a", "4_1_b")
...
text(x = q4_1, y = Q4_1_rel, label = paste("n = ", Q4_1_sum, " / ", round(Q4_1_rel, digits = 0), "%", sep = ""), pos = 3, cex = 0.8, col = "black")
...
q4_2 <- barplot(Q4_2_rel,
        ...
        ylim = c(0,max(Q4_2_rel)+5), yaxt='n')
text(x = q4_2, y = Q4_2_rel, label = paste("n = ", Q4_2_sum, " / ", round(Q4_2_rel, digits = 0), "%", sep = ""), pos = 3, cex = 0.8, col = "black")

Q4_3_sum <- as.numeric(table(Q4_3))
names(Q4_3_sum) <- c("4_3_a", "4_3_b", "4_3_c", "4_3_d", "4_3_e", "4_3_f", "4_3_g", "4_3_h", "4_3_i", "4_3_j")
...
text(x = q4_3, y = Q4_3_rel, label = paste("n = ", Q4_3_sum, " / ", round(Q4_3_rel, digits = 0), "%", sep = ""), pos = 3, cex = 0.8, col = "black")
...
q4_4 <- barplot(Q4_4_rel,
        ...
        ylim = c(0,max(Q4_4_rel)+5), yaxt='n')
text(x = q4_4, y = Q4_4_rel, label = paste("n = ", Q4_4_sum, " / ", round(Q4_4_rel, digits = 0), "%", sep = ""), pos = 3, cex = 0.8, col = "black")
...
q4_5 <- barplot(Q4_5_rel,
        ...
        ylim = c(0,max(Q4_5_rel)+5), yaxt='n')
text(x = q4_5, y = Q4_5_rel, label = paste("n = ", Q4_5_sum, " / ", round(Q4_5_rel, digits = 0), "%", sep = ""), pos = 3, cex = 0.8, col = "black")
...
text(x = q4_6, y = Q4_6_rel, label = paste("n = ", Q4_6_sum, " / ", round(Q4_6_rel, digits = 0), "%", sep = ""), pos = 3, cex = 0.8, col = "black")
```

...
Q1_1 <- transform(Q1_1, X1_1_a = as.numeric(X1_1_a), X1_1_b = as.numeric(X1_1_b), X1_1_c = as.numeric(X1_1_c), X1_1_d = as.numeric(X1_1_d))
...
barplot(Q1_1_rel,
        ...
        sub = paste("n", "=", length(rowSums(Q1_1, na.rm=T)!=0), sep = " "),
        ylab = "Prozent",
        names.arg = c("Datenbereitstellung", "Datenaufbereitung", "Datenverschmelzung", "Mit keinem 'dieser' Schritte"),
        ylim = c(0,50))
text(x = Q1_1_rel, label = round(Q1_1_rel, digits = 0), pos = 3, cex = 0.8, col = "black")
```

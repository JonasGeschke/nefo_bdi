...
plot(Q1_1, main = "Mit welchem dieser Schritte der Biodiversitätsdatenintegration beschäftigen Sie sich?")
plot(Q4_1, main = "Geschlechterverteilung")
plot(Q4_2, main = "Altersverteilung")
plot(Q4_3, main = "Höchste Abschlüsse")
plot(Q4_4, main = "Aktuelle Tätigkeit")
plot(Q4_5, main = "Kategorie des Arbeitgebers")
plot(Q4_6, main = "Skala der Anwendung von Biodiversitätsdaten")

Q1_1_rel <- prop.table(table(results$Q1_1[!is.na(results$Q1_1)]))
barplot(Q1_1_rel*100,
        main = "Mit welchem dieser Schritte der Biodiversitätsdatenintegration beschäftigen Sie sich?", 
        sub = paste("n", "=", length(Q1_1[!is.na(Q1_1)]), sep = " "),
        ylab = "Prozent")

Q1_2_rel <- prop.table(table(results$Q1_2[!is.na(results$Q1_2)]))
barplot(Q1_2_rel*100,
        main = "Wie viel Ihrer Arbeitszeit beschäftigen Sie sich mit der Biodiversitätsdatenintegration?", 
        sub = paste("n", "=", length(Q1_2[!is.na(Q1_2)]), sep = " "),
        ylab = "Prozent")
```
